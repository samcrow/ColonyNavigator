	...
	private void updateMessage() {
		if(message == null) {
			...
			if(message.getDirection() == Direction.Sent) {
				final Drawable chatSolid = getContext().getResources().getDrawable(R.drawable.ic_chat_bubble_black_36dp);
				if(chatSolid != null) {
				...
				final Drawable chatOutline = getContext().getResources().getDrawable(R.drawable.ic_chat_bubble_outline_black_36dp);
				if(chatOutline != null) {
