...
public class UpdateCheckActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.update_check_cancel_button).setOnClickListener(
        ...
        try {
            ...
            download.start(Uri.parse(versionFileUrl.toString()),
                    Uri.parse(downloadLocationFile.toURI().toString()));
    ...
    private void handleVersionFile(InputStream stream, URL folderUrl)
        ...
        try {
            ...
            if (newVersionCode > currentVersionCode) {
                ...
                final Intent intent = new Intent(UpdateActivity.ACTION_START_DOWNLOAD,
                        Uri.parse(updatePackageUrl.toString()), this, UpdateActivity.class);
