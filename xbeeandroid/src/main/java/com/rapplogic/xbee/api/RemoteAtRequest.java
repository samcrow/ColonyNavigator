...
public class RemoteAtRequest extends AtCommand {
     ...
     */
    public RemoteAtRequest(int frameId, XBeeAddress64 remoteAddress64,
                           XBeeAddress16 remoteAddress16, boolean applyChanges, String command,
                           int[] value) {
        super(command, value);
    ...
    public RemoteAtRequest(XBeeAddress64 dest64, String command, int[] value) {
        ...
        this(XBeeRequest.DEFAULT_FRAME_ID, dest64, XBeeAddress16.ZNET_BROADCAST, true, command,
                value);
    }
    ...
    public RemoteAtRequest(XBeeAddress16 remoteAddress16, String command, int[] value) {
        this(XBeeRequest.DEFAULT_FRAME_ID, XBeeAddress64.BROADCAST, remoteAddress16, true, command,
                value);
    }
